...
;; $Source: /home/gfe/src/ksh-mode/RCS/ksh-mode.el,v $ --  
;;
;; LCD Archive Entry:
;; ksh-mode|Gary Ellison|gfe@interhack.net
;; |Mode for editing sh/ksh/bash scripts
;; |$Date: 1999/04/29 21:41:38 $|$Revision: 2.12 $|~/modes/ksh-mode.el.Z|
...
;;
;; Delta On   $Date: 1999/04/29 21:41:38 $
...
(defconst ksh-mode-version "$Revision: 2.12 $"
...
;;;###autoload
(defun ksh-mode ()
  "ksh-mode $Revision: 2.12 $ - Major mode for editing (Bourne, Korn or Bourne again)
shell scripts.
